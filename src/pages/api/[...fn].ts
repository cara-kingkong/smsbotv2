...
const handlers: Record<string, (req: Request, ctx: unknown) => Promise<Response>> = {
  ...
  'api-conversation-diagnostics': (await import('../../../netlify/functions/api-conversation-diagnostics')).default,
  ...
  'api-inbox-mark-booked': (await import('../../../netlify/functions/api-inbox-mark-booked')).default,
  ...
  'api-calendar-events-list': (await import('../../../netlify/functions/api-calendar-events-list')).default,
  ...
  'api-campaign-calendars-list': (await import('../../../netlify/functions/api-campaign-calendars-list')).default,
  'api-campaign-calendars-assign': (await import('../../../netlify/functions/api-campaign-calendars-assign')).default,
  'api-campaign-calendars-remove': (await import('../../../netlify/functions/api-campaign-calendars-remove')).default,
  ...
  'api-workspace-phone-numbers-list': (await import('../../../netlify/functions/api-workspace-phone-numbers-list')).default,
  'api-workspace-phone-numbers-create': (await import('../../../netlify/functions/api-workspace-phone-numbers-create')).default,
  'api-workspace-phone-numbers-update': (await import('../../../netlify/functions/api-workspace-phone-numbers-update')).default,
  'api-workspace-phone-numbers-delete': (await import('../../../netlify/functions/api-workspace-phone-numbers-delete')).default,
  'api-workspace-switch': (await import('../../../netlify/functions/api-workspace-switch')).default,
  'api-workspace-members-list': (await import('../../../netlify/functions/api-workspace-members-list')).default,
  'api-admin-workspaces-list': (await import('../../../netlify/functions/api-admin-workspaces-list')).default,
  'api-admin-workspaces-create': (await import('../../../netlify/functions/api-admin-workspaces-create')).default,
  'api-admin-workspaces-update': (await import('../../../netlify/functions/api-admin-workspaces-update')).default,
  'api-admin-workspaces-delete': (await import('../../../netlify/functions/api-admin-workspaces-delete')).default,
  'api-admin-workspace-members-add': (await import('../../../netlify/functions/api-admin-workspace-members-add')).default,
  'api-admin-workspace-members-remove': (await import('../../../netlify/functions/api-admin-workspace-members-remove')).default,
  'api-admin-workspace-members-update-role': (await import('../../../netlify/functions/api-admin-workspace-members-update-role')).default,
  'webhook-start-conversation': (await import('../../../netlify/functions/webhook-start-conversation')).default,
  'api-debug-conversation-create': (await import('../../../netlify/functions/api-debug-conversation-create')).default,
  'api-debug-conversation-send': (await import('../../../netlify/functions/api-debug-conversation-send')).default,
  'api-debug-conversation-messages': (await import('../../../netlify/functions/api-debug-conversation-messages')).default,
  'api-debug-conversation-list': (await import('../../../netlify/functions/api-debug-conversation-list')).default,
  'api-debug-conversation-delete': (await import('../../../netlify/functions/api-debug-conversation-delete')).default,
