...
export class KeapAdapter implements CRMAdapter {
  ...
  // Authenticates with a Keap Personal Access Token via the standard
  // `Authorization: Bearer` header. Service Account Keys (X-Keap-API-Key)
  // are no longer supported here — they cannot be generated by all Keap
  // account types, so we standardize on PATs.
  constructor(
