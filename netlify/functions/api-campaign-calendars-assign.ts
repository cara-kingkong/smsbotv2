...
/**
 * Assign a calendar to a campaign.
 * POST /.netlify/functions/api-campaign-calendars-assign
 *
...
export default async (req: Request, _context: Context) => {
  ...
  try {
    ...
    const assignment = await service.assignToCampaign({
    ...
    console.error('api-campaign-calendars-assign error:', err);
    return new Response(
